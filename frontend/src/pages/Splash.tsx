  ...
  return <div className="splash"><div className="bg" aria-hidden="true" />
    <section className="hero-splash">
      <div className="hero-copy">
        ...
        <p className="lede">Read the live DreamDEX book, set an executable limit, and see the exact checks that stand between an idea and your wallet signature.</p>
        <div className="category-chips" aria-label="Product capabilities"><span>Live order books</span><span>Pre-trade checks</span><span>On-chain settlement</span></div>
