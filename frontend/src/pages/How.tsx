...
export default function How() {
  return <div className="app how"><div className="bg" aria-hidden="true" />
    <section className="pitch">
      ...
      <h1>AI proposes.<br /><em>Policy controls.</em></h1>
    ...
    <main className="grid how-grid">
      <section className="card"><div className="card-label">ORDER FLOW</div><ol className="flow">
        ...
        <li><b>Propose.</b> A user or agent provides the outcome, size, price, and thesis for a potential order.</li>
        <li><b>Control.</b> Deterministic limits evaluate size, tail pricing, liquidity, concentration, and time-to-expiry.</li>
        <li><b>Execute.</b> Approved orders are signed by the connected wallet and submitted as DreamDEX IOC orders on Somnia.</li>
      </ol></section>
      <section className="card"><div className="card-label">CONTROL MODEL</div><p className="muted">AI provides context and a readable thesis. It cannot override a deterministic block.</p><div className="bands"><div className="band-row"><span className="badge s1">PASS</span> Order can reach the wallet signer</div><div className="band-row"><span className="badge s0">REVIEW</span> User sees elevated risk before signing</div><div className="band-row"><span className="badge s2">BLOCK</span> Execution control remains disabled</div></div><p className="muted small">The final transaction, position accounting, market resolution, and redemption state are all sourced from DreamDEX Event Contracts.</p></section>
